...
$.innerKeyWords =
    [
        "幼儿园", "教程", "英语", "辅导", "培训",
        "孩子", "小学" , "宝宝", "玩具", "芭比", "娃娃", "男用",
        "女用",  "足力健", "老年", "老人",
        "宠物", "饲料", "丝袜",  "磨脚",
         "除臭", "数学" , "语文", "手机", "电脑", "苹果", "联想", "华为", "动画", "汽车", "电动车", "摩托"
    ]
//下面很重要，遇到问题请把下面注释看一遍再来问
let args_xh = {
    env: process.env.JD_TRY === null || true,
    /*
     * 控制是否输出当前环境变量设置，默认为false
     * 环境变量名称：XH_TRY_ENV
     */
    env: process.env.XH_TRY_ENV === 'true' || true,
    /*
     * 跳过某个指定账号，默认为全部账号清空
     ...
     */
    except: process.env.XH_TRY_EXCEPT && process.env.XH_TRY_EXCEPT.split('@') || ['%E5%BE%85%E5%AE%9A%E4%B8%B6%E4%BA%BA%E7%94%9F'],
    //以上环境变量新增于2022.01.30
    /*
